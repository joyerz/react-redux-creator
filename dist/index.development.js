...
var createRootReducer = function createRootReducer(history, reducers) {
  return Object(redux__WEBPACK_IMPORTED_MODULE_4__["combineReducers"])(_objectSpread({
...
function configureStore(initState, reducers, sagas) {
  var middleWare = [sagaMiddleware, Object(connected_react_router__WEBPACK_IMPORTED_MODULE_5__["routerMiddleware"])(history) // for dispatching history actions
  ];
  ...
  var store = Object(redux__WEBPACK_IMPORTED_MODULE_4__["createStore"])(createRootReducer(history, reducers), initState, Object(redux__WEBPACK_IMPORTED_MODULE_4__["compose"])(redux__WEBPACK_IMPORTED_MODULE_4__["applyMiddleware"].apply(void 0, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(middleWare))));
  sagaMiddleware.run(
  /*#__PURE__*/
