...
switch (_settings__WEBPACK_IMPORTED_MODULE_8__["options"].history) {
  case 'browser':
    historyStore = Object(history__WEBPACK_IMPORTED_MODULE_2__["createBrowserHistory"])();
    break;

  case 'hash':
    historyStore = Object(history__WEBPACK_IMPORTED_MODULE_2__["createHashHistory"])();
    break;

  case 'memory':
    historyStore = Object(history__WEBPACK_IMPORTED_MODULE_2__["createMemoryHistory"])();
    break;
...
function configureStore(initState, reducers, sagas) {
  var middleWare = [sagaMiddleware, Object(connected_react_router__WEBPACK_IMPORTED_MODULE_4__["routerMiddleware"])(history) // for dispatching history actions
  ];
